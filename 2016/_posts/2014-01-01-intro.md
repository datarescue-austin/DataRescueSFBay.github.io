...
<div  class="row" align="center">
  <img src={{site-url}}"/img/DataRefuge-logo-large.png" alt="Logo" class="img-responsive" style="width:250px;"/><img src={{site-url}}"/img/iSchool-logo-large.jpg" alt="Logo" class="img-responsive" style="width:250px;"/><img src={{site-url}}"/img/EDGI-logo-large.png" alt="Logo" class="img-responsive" style="width:250px;"/>
</div>
