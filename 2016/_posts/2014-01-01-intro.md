...
<div class="row" align="center">
  <img src={{site-url}}"/img/DataRefuge-logo-small.png" alt="Logo" class="img-responsive"> <img src={{site-url}}"/img/iSchool-logo-large.jpg" alt="Logo" class="img-responsive" style="width:300px;"/> <img src={{site-url}}"/img/EDGI-logo-small.png" alt="Logo" class="img-responsive">
</div>
